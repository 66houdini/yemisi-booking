          ...
          <div className="text-white grid md:grid-cols-2 space-x-3 md:space-x-10 shadow-2xl">
            ...
            <div className="bg-white text-black p-3 rounded h-fit md:space-y-2">
              ...
              <h1 className="text-sm md:text-base">
                ...
                <br/> ✓Understanding of Digital Marketing
                Platforms: I will guide you through how various digital
                marketing platforms operate and the different results they can
                produce.<br/>
                 ✓Platform Identification:Together, we’ll identify the
                digital marketing platform that best aligns with your business
                and brand needs. <br/>
                ✓Results-Driven Strategies: I will provide you
