        ...
        <div className="p-5 md:p-20 self-center">
          ...
          {showCalendly && (
            <>
              ...
              ></div>
              {/* Calendly Component */}
              <Calendly urlLink="https://calendly.com/oluwayemisiadebayo/group-session" />
            </>
          )}
          <div className="text-white grid md:grid-cols-2 space-x-3 md:space-x-10 shadow-2xl">
            ...
            <div className="bg-white text-black p-3 rounded h-fit md:space-y-2">
              ...
              <h2 className="md:text-xl">GROUP SESSION</h2>
              <h1 className="text-sm md:text-base">
                This Group Session is designed to inspire and empower
                participants to unlock their full potential. Through engaging
                discussions, collaborative activities, and goal-setting
                exercises, you&apos;ll learn practical strategies to overcome
