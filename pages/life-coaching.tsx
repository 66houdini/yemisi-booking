      ...
      >
        ...
        <div className="p-10 md:p-20 self-center">
          ...
          <>
            ...
            ></div>
            {/* Calendly Component */}
            <Calendly urlLink="https://calendly.com/oluwayemisiadebayo/life-coaching-starter" />
          </>
        )}
          <div className="text-white grid grid-cols-2 space-x-3 md:space-x-10 shadow-2xl">
            ...
            <div className="bg-white text-black p-3 rounded h-fit md:space-y-2">
              <h1 className="text-lg md:text-2xl font-bold">LIFE COACHING PACKAGES</h1>
              <h2 className="md:text-xl">PERSONAL DEVELOPMENT</h2>
